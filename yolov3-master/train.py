...
def parse_opt(known=False):
    ...
    parser.add_argument('--epochs', type=int, default=1) # MV default 300
    parser.add_argument('--batch-size', type=int, default=1, help='total batch size for all GPUs, -1 for autobatch') # MV default 16
